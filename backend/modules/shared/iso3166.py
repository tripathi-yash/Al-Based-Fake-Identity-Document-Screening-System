...
MOVED from backend/modules/module2_validation/ to backend/modules/shared/,
alongside face_embedding_utils.py — this is general reference data, not
Module-2-specific logic (checksum.py, by contrast, IS genuinely
Module-2-specific MRZ math and correctly stays inside module2_validation/).
Moving it here makes it available to any future module that needs country
code validation (e.g. Module 5 cross-checking nationality against an
authority record) without duplicating the table.
